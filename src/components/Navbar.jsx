...
const Navbar = () => {
  ...
  const linkClass = ({isActive}) => isActive ? 'px-3 py-2 text-white rounded-md bg-black hover:bg-gray-900 hover:text-white' : 'px-3 py-2 text-white rounded-md hover:bg-gray-900 hover:text-white'
