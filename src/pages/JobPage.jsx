          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-70/30">
            ...
            <aside>
              ...
              <div className="p-6 mt-6 bg-white rounded-lg shadow-md">
                ...
                <button onClick={ () => onDeleteClick(job.id)} className="block w-full px-4 py-2 mt-4 font-bold text-white bg-red-500 rounded-full hover:bg-red-600 focus:outline-none focus:shadow-outline">
                  Delete Job
                </button>
              </div>
            </aside>
